...
@Named
@ViewScoped
public class CreRptDesembolsoCreditoController extends GenericMensajes implements Serializable {
    ...
    public void imprimir() {
        ...
        parametros.put("p_fecha_ini", "'" + sdf.format(fechaInicio) + "'");
        ...
        imprimirReporte.setNombreReporte("CreRptDesembolsoCredito");
...
//<editor-fold defaultstate="collapsed" desc="Getters&Setters">
    ...
    public void setFechaInicio(Date fechaInicio) {
        System.out.println("paso por setFechaInicio " + fechaInicio);
    ...
    public void setFechaFin(Date fechaFin) {
        System.out.println("paso por setFechaFin " + fechaFin);
