...
@Named
@ViewScoped
public class CobRptClientesController extends GenericMensajes implements Serializable {
    ...
    public void imprimir() {
        ...
        parametros.put("p_cod_clienteD", clientesDesde.getCodCliente() != null ? "'"+clientesDesde.getCodCliente()+"'" : null);
        parametros.put("nomClienteD", clientesDesde.getCodCliente() != null ? clientesDesde.getBsPersonas().getNombreFantasia() : null);
        parametros.put("p_cod_clienteH", clienteHasta.getCodCliente() != null ? "'"+clienteHasta.getCodCliente()+"'" : null);
        ...
        imprimirReporte.setNombreReporte("CobRptClientes");
